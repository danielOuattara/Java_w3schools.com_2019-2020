package _03_Java_Classes._13_interface;
...
public class MainInterface {
    ...
    a kind like inherited by another class with the "implements" keyword
    instead of extends.
    ...
    > Like abstract classes, interfaces cannot be used to create objects
      In the example above, it is not possible to create an "Animal" object
      in the Main Class
