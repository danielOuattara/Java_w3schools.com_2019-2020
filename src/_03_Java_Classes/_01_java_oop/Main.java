...
public class Main {
    public static void main(String[] args) {
        ...
        > helps to keep the Java code DRY "Don't Repeat Yourself", and makes
        ...
        Tip: The "Don't Repeat Yourself" (DRY) principle is about reducing the
             repetition of code. You should extract out the codes that are
        ...
        programming. Look at the following illustration to see the difference
        ...
        of a class. When the individual objects are created, they inherit
