package _03_Java_Classes._15_user_input;
...
//}
    ...
    Input Types
    ------------
    In the example above, we used the 'nextLine()' method, which is used
    to read Strings. To read other types, look at the table below:
    ...
    In the example below, we use different methods to read data
    of various types:*/
