package _03_Java_Classes._18_LinkedList;
...
The 'LinkedList' class has the same methods as the ArrayList
class because they both implement the List interface. This
means that you can add items, change items, remove items and
clear the list in the same way.

However, while the 'ArrayList' class and the 'LinkedList' class
can be used in the same way, they are built very differently.
...
When To Use
------------
Use an 'ArrayList' for storing and accessing data, and 'LinkedList'
to manipulate data.


LinkedList Methods
-------------------
For many cases, the 'ArrayList' is more efficient as it is common
to need access to random items in the list, but the LinkedList
