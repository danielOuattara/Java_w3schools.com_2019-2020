package _03_Java_Classes._09_inheritance;
...
public class Main {
    ...
    ------------------------------------
    It is useful for code re-usability: reuse attributes and methods of an
    ...
    keyword. If you try to access a final class, Java will generate an error:
